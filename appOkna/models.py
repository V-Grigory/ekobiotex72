...
class CategoryProduct (models.Model):
    ...
    pagetitle = models.CharField('title', max_length=100, default='', blank=True)
    description = models.TextField('description', max_length=1000, default='', blank=True)
    keywords = models.CharField('keywords', max_length=600, default='', blank=True)
...
#     informationarticle = models.OneToOneField(InformationArticles, on_delete=models.CASCADE, primary_key=False, default=None, blank=True, null=True)
...
class Mainpage (models.Model):
    title = models.CharField('title', max_length=100, default='Товар', blank=False)
    description = models.TextField('description', max_length=1000, default='Описание товара', blank=False)
    keywords = models.TextField('keywords', max_length=600, default='Ключевые слова', blank=False)
